export interface GdprModuleManifest {
	id: string;
	displayName: string;
	version: string;
	description: string;
...
export const gdprModuleManifest: GdprModuleManifest = {
	...
	version: "0.1.0",
	description:
		"Optional reference module that adds GDPR request routing, provider orchestration, and audit trails through public extension seams.",
	author: "TBD",
	license: "MIT",
	compatibility: {
